...
export default {
  ...
  mounted () {
    ...
    _viewer.cesiumWidget.container.appendChild(this.$refs.viewshedSettingPanel.$el)
    _viewer.cesiumWidget.container.appendChild(this.$refs.sunlightSettingPanel.$el)
    _viewer.cesiumWidget.container.appendChild(this.$refs.highLimitSettingPanel.$el)
    _viewer.cesiumWidget.container.appendChild(this.$refs.modelObservationPanel.$el)
    _viewer.cesiumWidget.container.appendChild(this.$refs.commonSettingsPanel.$el)

    let _this = this
    _viewer.camera.changed.addEventListener(function () {
      _this.$refs.compass.style = `transform: rotateZ(-${Cesium.Math.toDegrees(_viewer.camera.heading)}deg);`
    })
